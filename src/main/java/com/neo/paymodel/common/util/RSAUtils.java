...
//		secureRandom.setSeed(seed.getBytes());
	 ...
	 * 
	 */
	public static String signByPrivateKey(String signStr, String privateKey) throws Exception {
		logger.info("用私钥对信息进行数字签名");
		byte[] data =signStr.getBytes(CHARSET);// decryptBASE64(signStr);
...
//		return buffer;
	...
	public static String signByPrivateKeyForMap(Map<String, String> map, String signKey) throws Exception {
        ...
        logger.info("RSA2---Sign：{}", s2.toString(),signKey);
        return signByPrivateKey(s2.toString(),signKey);
